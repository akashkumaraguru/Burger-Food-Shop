...
const CardLayout = (props) => {
  return (
    <div className=" w-fit p-5  overflow-hidden flex flex-col relative">
      <div className="absolute  w-[400px] h-full rounded-xl overflow-hidden p-5 z-30 text-white flex flex-col justify-center  gap-5">
      ...
      <div className="bg-black">
        <img
          src={props.img}
          alt=""
          className="w-[400px] opacity-30  h-auto object-cover rounded-md"
        />
      </div>
    </div>
  );
